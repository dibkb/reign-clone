...
class Atri:
	def __init__(self, state: Any):
		...
		self.Navbar_Container = state["Navbar_Container"]
		self.Nav_elements = state["Nav_elements"]
		self.navlinks = state["navlinks"]
		self.right = state["right"]
		self.cart = state["cart"]
		self.home_view1 = state["home_view1"]
		self.body_container = state["body_container"]
		self.body = state["body"]
		self.left = state["left"]
		self.home_view2 = state["home_view2"]
		self.homeview2_container = state["homeview2_container"]
		self.headlines2 = state["headlines2"]
		self.dualsport = state["dualsport"]
		self.freetest = state["freetest"]
		self.freespin = state["freespin"]
		self.body_view2 = state["body_view2"]
		self.helemtsbody = state["helemtsbody"]
		self.features = state["features"]
		self.features_container = state["features_container"]
		self.features_list_container = state["features_list_container"]
		self.Flex38 = state["Flex38"]
		self.Flex41 = state["Flex41"]
		self.Flex42 = state["Flex42"]
		self.pro_choic = state["pro_choic"]
		self.Flex44 = state["Flex44"]
		self.prochoice_left = state["prochoice_left"]
		self.rating_icons = state["rating_icons"]
		self.prochoice_right = state["prochoice_right"]
		self.Flex47 = state["Flex47"]
		self.images1 = state["images1"]
		...
		self.shop_section_container = state["shop_section_container"]
		self.shop_section = state["shop_section"]
		self.items_container = state["items_container"]
		...
		self.blogsection_continer = state["blogsection_continer"]
		self.blogs = state["blogs"]
		self.blog_one = state["blog_one"]
		self.blog_two = state["blog_two"]
		self.blog_three = state["blog_three"]
		self.FOOTER = state["FOOTER"]
		self.footer_container = state["footer_container"]
		self.top = state["top"]
		self.Flex108 = state["Flex108"]
		self.pages_footer_container = state["pages_footer_container"]
		self.Flex110 = state["Flex110"]
		self.misc_footer_container = state["misc_footer_container"]
		self.Flex113 = state["Flex113"]
		self.social_footer_container = state["social_footer_container"]
		self.Flex115 = state["Flex115"]
		self.conncet_social_container = state["conncet_social_container"]
		self.Flex117 = state["Flex117"]
		self.bottom = state["bottom"]
		self.atrilabs = state["atrilabs"]
		self.online_pay = state["online_pay"]
		self.headline_text = state["headline_text"]
		...
		self.google_rating_text = state["google_rating_text"]
		...
		self.Tangerine = state["Tangerine"]
	...
	def Headline(self, new_state):
		...
		global default_state
		self._Headline = Flex(new_state, default_state["Headline"])

	@property
	def Navbar_Container(self):
		self._getter_access_tracker["Navbar_Container"] = {}
		return self._Navbar_Container
	@Navbar_Container.setter
	def Navbar_Container(self, new_state):
		self._setter_access_tracker["Navbar_Container"] = {}
		global default_state
		self._Navbar_Container = Flex(new_state, default_state["Navbar_Container"])

	@property
	def Nav_elements(self):
		self._getter_access_tracker["Nav_elements"] = {}
		return self._Nav_elements
	@Nav_elements.setter
	def Nav_elements(self, new_state):
		self._setter_access_tracker["Nav_elements"] = {}
		global default_state
		self._Nav_elements = Flex(new_state, default_state["Nav_elements"])
	...
	def cart(self, new_state):
		...
		global default_state
		self._cart = Flex(new_state, default_state["cart"])

	@property
	def home_view1(self):
		self._getter_access_tracker["home_view1"] = {}
		return self._home_view1
	@home_view1.setter
	def home_view1(self, new_state):
		self._setter_access_tracker["home_view1"] = {}
		global default_state
		self._home_view1 = Flex(new_state, default_state["home_view1"])

	@property
	def body_container(self):
		self._getter_access_tracker["body_container"] = {}
		return self._body_container
	@body_container.setter
	def body_container(self, new_state):
		self._setter_access_tracker["body_container"] = {}
		global default_state
		self._body_container = Flex(new_state, default_state["body_container"])
	...
	@property
	def home_view2(self):
		self._getter_access_tracker["home_view2"] = {}
		return self._home_view2
	@home_view2.setter
	def home_view2(self, new_state):
		self._setter_access_tracker["home_view2"] = {}
		global default_state
		self._home_view2 = Flex(new_state, default_state["home_view2"])

	@property
	def homeview2_container(self):
		self._getter_access_tracker["homeview2_container"] = {}
		return self._homeview2_container
	@homeview2_container.setter
	def homeview2_container(self, new_state):
		self._setter_access_tracker["homeview2_container"] = {}
		global default_state
		self._homeview2_container = Flex(new_state, default_state["homeview2_container"])

	@property
	def headlines2(self):
		self._getter_access_tracker["headlines2"] = {}
		return self._headlines2
	@headlines2.setter
	def headlines2(self, new_state):
		self._setter_access_tracker["headlines2"] = {}
		global default_state
		self._headlines2 = Flex(new_state, default_state["headlines2"])

	@property
	def dualsport(self):
		self._getter_access_tracker["dualsport"] = {}
		return self._dualsport
	@dualsport.setter
	def dualsport(self, new_state):
		self._setter_access_tracker["dualsport"] = {}
		global default_state
		self._dualsport = Flex(new_state, default_state["dualsport"])

	@property
	def freetest(self):
		self._getter_access_tracker["freetest"] = {}
		return self._freetest
	@freetest.setter
	def freetest(self, new_state):
		self._setter_access_tracker["freetest"] = {}
		global default_state
		self._freetest = Flex(new_state, default_state["freetest"])

	@property
	def freespin(self):
		self._getter_access_tracker["freespin"] = {}
		return self._freespin
	@freespin.setter
	def freespin(self, new_state):
		self._setter_access_tracker["freespin"] = {}
		global default_state
		self._freespin = Flex(new_state, default_state["freespin"])

	@property
	def body_view2(self):
		self._getter_access_tracker["body_view2"] = {}
		return self._body_view2
	@body_view2.setter
	def body_view2(self, new_state):
		self._setter_access_tracker["body_view2"] = {}
		global default_state
		self._body_view2 = Flex(new_state, default_state["body_view2"])

	@property
	def helemtsbody(self):
		self._getter_access_tracker["helemtsbody"] = {}
		return self._helemtsbody
	@helemtsbody.setter
	def helemtsbody(self, new_state):
		self._setter_access_tracker["helemtsbody"] = {}
		global default_state
		self._helemtsbody = Flex(new_state, default_state["helemtsbody"])

	@property
	def features(self):
		self._getter_access_tracker["features"] = {}
		return self._features
	@features.setter
	def features(self, new_state):
		self._setter_access_tracker["features"] = {}
		global default_state
		self._features = Flex(new_state, default_state["features"])

	@property
	def features_container(self):
		self._getter_access_tracker["features_container"] = {}
		return self._features_container
	@features_container.setter
	def features_container(self, new_state):
		self._setter_access_tracker["features_container"] = {}
		global default_state
		self._features_container = Flex(new_state, default_state["features_container"])

	@property
	def features_list_container(self):
		self._getter_access_tracker["features_list_container"] = {}
		return self._features_list_container
	@features_list_container.setter
	def features_list_container(self, new_state):
		self._setter_access_tracker["features_list_container"] = {}
		global default_state
		self._features_list_container = Flex(new_state, default_state["features_list_container"])
	...
	@property
	def pro_choic(self):
		self._getter_access_tracker["pro_choic"] = {}
		return self._pro_choic
	@pro_choic.setter
	def pro_choic(self, new_state):
		self._setter_access_tracker["pro_choic"] = {}
		global default_state
		self._pro_choic = Flex(new_state, default_state["pro_choic"])
	...
	@property
	def prochoice_left(self):
		self._getter_access_tracker["prochoice_left"] = {}
		return self._prochoice_left
	@prochoice_left.setter
	def prochoice_left(self, new_state):
		self._setter_access_tracker["prochoice_left"] = {}
		global default_state
		self._prochoice_left = Flex(new_state, default_state["prochoice_left"])

	@property
	def rating_icons(self):
		self._getter_access_tracker["rating_icons"] = {}
		return self._rating_icons
	@rating_icons.setter
	def rating_icons(self, new_state):
		self._setter_access_tracker["rating_icons"] = {}
		global default_state
		self._rating_icons = Flex(new_state, default_state["rating_icons"])

	@property
	def prochoice_right(self):
		self._getter_access_tracker["prochoice_right"] = {}
		return self._prochoice_right
	@prochoice_right.setter
	def prochoice_right(self, new_state):
		self._setter_access_tracker["prochoice_right"] = {}
		global default_state
		self._prochoice_right = Flex(new_state, default_state["prochoice_right"])
	...
	@property
	def images1(self):
		self._getter_access_tracker["images1"] = {}
		return self._images1
	@images1.setter
	def images1(self, new_state):
		self._setter_access_tracker["images1"] = {}
		global default_state
		self._images1 = Flex(new_state, default_state["images1"])
	...
	def image_2(self, new_state):
		...
		global default_state
		self._image_2 = Flex(new_state, default_state["image_2"])
	...
	def image_3(self, new_state):
		...
		global default_state
		self._image_3 = Flex(new_state, default_state["image_3"])
	...
	@property
	def shop_section_container(self):
		self._getter_access_tracker["shop_section_container"] = {}
		return self._shop_section_container
	@shop_section_container.setter
	def shop_section_container(self, new_state):
		self._setter_access_tracker["shop_section_container"] = {}
		global default_state
		self._shop_section_container = Flex(new_state, default_state["shop_section_container"])

	@property
	def shop_section(self):
		self._getter_access_tracker["shop_section"] = {}
		return self._shop_section
	@shop_section.setter
	def shop_section(self, new_state):
		self._setter_access_tracker["shop_section"] = {}
		global default_state
		self._shop_section = Flex(new_state, default_state["shop_section"])

	@property
	def items_container(self):
		self._getter_access_tracker["items_container"] = {}
		return self._items_container
	@items_container.setter
	def items_container(self, new_state):
		self._setter_access_tracker["items_container"] = {}
		global default_state
		self._items_container = Flex(new_state, default_state["items_container"])
	...
	def text(self, new_state):
		...
		global default_state
		self._text = Flex(new_state, default_state["text"])
	...
	def blog_section(self, new_state):
		...
		global default_state
		self._blog_section = Flex(new_state, default_state["blog_section"])

	@property
	def blogsection_continer(self):
		self._getter_access_tracker["blogsection_continer"] = {}
		return self._blogsection_continer
	@blogsection_continer.setter
	def blogsection_continer(self, new_state):
		self._setter_access_tracker["blogsection_continer"] = {}
		global default_state
		self._blogsection_continer = Flex(new_state, default_state["blogsection_continer"])
	...
	@property
	def blog_one(self):
		self._getter_access_tracker["blog_one"] = {}
		return self._blog_one
	@blog_one.setter
	def blog_one(self, new_state):
		self._setter_access_tracker["blog_one"] = {}
		global default_state
		self._blog_one = Flex(new_state, default_state["blog_one"])

	@property
	def blog_two(self):
		self._getter_access_tracker["blog_two"] = {}
		return self._blog_two
	@blog_two.setter
	def blog_two(self, new_state):
		self._setter_access_tracker["blog_two"] = {}
		global default_state
		self._blog_two = Flex(new_state, default_state["blog_two"])

	@property
	def blog_three(self):
		self._getter_access_tracker["blog_three"] = {}
		return self._blog_three
	@blog_three.setter
	def blog_three(self, new_state):
		self._setter_access_tracker["blog_three"] = {}
		global default_state
		self._blog_three = Flex(new_state, default_state["blog_three"])
	...
	def footer_container(self):
		self._getter_access_tracker["footer_container"] = {}
		return self._footer_container
	@footer_container.setter
	def footer_container(self, new_state):
		self._setter_access_tracker["footer_container"] = {}
		global default_state
		self._footer_container = Flex(new_state, default_state["footer_container"])
	...
	def top(self):
		...
		return self._top
	@top.setter
	def top(self, new_state):
		self._setter_access_tracker["top"] = {}
		global default_state
		self._top = Flex(new_state, default_state["top"])
	...
	@property
	def pages_footer_container(self):
		self._getter_access_tracker["pages_footer_container"] = {}
		return self._pages_footer_container
	@pages_footer_container.setter
	def pages_footer_container(self, new_state):
		self._setter_access_tracker["pages_footer_container"] = {}
		global default_state
		self._pages_footer_container = Flex(new_state, default_state["pages_footer_container"])
	...
	@property
	def misc_footer_container(self):
		self._getter_access_tracker["misc_footer_container"] = {}
		return self._misc_footer_container
	@misc_footer_container.setter
	def misc_footer_container(self, new_state):
		self._setter_access_tracker["misc_footer_container"] = {}
		global default_state
		self._misc_footer_container = Flex(new_state, default_state["misc_footer_container"])
	...
	@property
	def social_footer_container(self):
		self._getter_access_tracker["social_footer_container"] = {}
		return self._social_footer_container
	@social_footer_container.setter
	def social_footer_container(self, new_state):
		self._setter_access_tracker["social_footer_container"] = {}
		global default_state
		self._social_footer_container = Flex(new_state, default_state["social_footer_container"])
	...
	@property
	def conncet_social_container(self):
		self._getter_access_tracker["conncet_social_container"] = {}
		return self._conncet_social_container
	@conncet_social_container.setter
	def conncet_social_container(self, new_state):
		self._setter_access_tracker["conncet_social_container"] = {}
		global default_state
		self._conncet_social_container = Flex(new_state, default_state["conncet_social_container"])
	...
	def bottom(self):
		...
		return self._bottom
	@bottom.setter
	def bottom(self, new_state):
		self._setter_access_tracker["bottom"] = {}
		global default_state
		self._bottom = Flex(new_state, default_state["bottom"])

	@property
	def atrilabs(self):
		self._getter_access_tracker["atrilabs"] = {}
		return self._atrilabs
	@atrilabs.setter
	def atrilabs(self, new_state):
		self._setter_access_tracker["atrilabs"] = {}
		global default_state
		self._atrilabs = Flex(new_state, default_state["atrilabs"])

	@property
	def online_pay(self):
		self._getter_access_tracker["online_pay"] = {}
		return self._online_pay
	@online_pay.setter
	def online_pay(self, new_state):
		self._setter_access_tracker["online_pay"] = {}
		global default_state
		self._online_pay = Flex(new_state, default_state["online_pay"])

	@property
	def headline_text(self):
		self._getter_access_tracker["headline_text"] = {}
		return self._headline_text
	@headline_text.setter
	def headline_text(self, new_state):
		self._setter_access_tracker["headline_text"] = {}
		global default_state
		self._headline_text = TextBox(new_state, default_state["headline_text"])
	...
	def Shop(self, new_state):
		...
		global default_state
		self._Shop = TextBox(new_state, default_state["Shop"])
	...
	def FEATURES(self, new_state):
		self._setter_access_tracker["FEATURES"] = {}
		global default_state
		self._FEATURES = TextBox(new_state, default_state["FEATURES"])
	...
	@property
	def google_rating_text(self):
		self._getter_access_tracker["google_rating_text"] = {}
		return self._google_rating_text
	@google_rating_text.setter
	def google_rating_text(self, new_state):
		self._setter_access_tracker["google_rating_text"] = {}
		global default_state
		self._google_rating_text = TextBox(new_state, default_state["google_rating_text"])
	...
	@property
	def Tangerine(self):
		self._getter_access_tracker["Tangerine"] = {}
		return self._Tangerine
	@Tangerine.setter
	def Tangerine(self, new_state):
		self._setter_access_tracker["Tangerine"] = {}
		global default_state
		self._Tangerine = TextBox(new_state, default_state["Tangerine"])
	...
	def _to_json_fields(self):
		return {
			...
			"Navbar_Container": self._Navbar_Container,
			"Nav_elements": self._Nav_elements,
			"navlinks": self._navlinks,
			"right": self._right,
			"cart": self._cart,
			"home_view1": self._home_view1,
			"body_container": self._body_container,
			"body": self._body,
			"left": self._left,
			"home_view2": self._home_view2,
			"homeview2_container": self._homeview2_container,
			"headlines2": self._headlines2,
			"dualsport": self._dualsport,
			"freetest": self._freetest,
			"freespin": self._freespin,
			"body_view2": self._body_view2,
			"helemtsbody": self._helemtsbody,
			"features": self._features,
			"features_container": self._features_container,
			"features_list_container": self._features_list_container,
			"Flex38": self._Flex38,
			"Flex41": self._Flex41,
			"Flex42": self._Flex42,
			"pro_choic": self._pro_choic,
			"Flex44": self._Flex44,
			"prochoice_left": self._prochoice_left,
			"rating_icons": self._rating_icons,
			"prochoice_right": self._prochoice_right,
			"Flex47": self._Flex47,
			"images1": self._images1,
			"Flex57": self._Flex57,
			"Flex56": self._Flex56,
			"Flex59": self._Flex59,
			...
			"Flex66": self._Flex66,
			"Flex65": self._Flex65,
			"shop_section_container": self._shop_section_container,
			"shop_section": self._shop_section,
			"items_container": self._items_container,
			"item_1": self._item_1,
			"text": self._text,
			"Flex79": self._Flex79,
			"Flex78": self._Flex78,
			...
			"blogsection_continer": self._blogsection_continer,
			"blogs": self._blogs,
			"blog_one": self._blog_one,
			"blog_two": self._blog_two,
			"blog_three": self._blog_three,
			"FOOTER": self._FOOTER,
			"footer_container": self._footer_container,
			"top": self._top,
			"Flex108": self._Flex108,
			"pages_footer_container": self._pages_footer_container,
			"Flex110": self._Flex110,
			"misc_footer_container": self._misc_footer_container,
			"Flex113": self._Flex113,
			"social_footer_container": self._social_footer_container,
			"Flex115": self._Flex115,
			"conncet_social_container": self._conncet_social_container,
			"Flex117": self._Flex117,
			"bottom": self._bottom,
			"atrilabs": self._atrilabs,
			"online_pay": self._online_pay,
			"headline_text": self._headline_text,
			"logo": self._logo,
			"Home": self._Home,
			"Shop": self._Shop,
			"Pages": self._Pages,
			...
			"google_rating_text": self._google_rating_text,
